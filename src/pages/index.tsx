...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Velocity Inventory`}</title>

        <meta
          name="description"
          content="Experience Velocity Inventory: Streamlining your inventory records with precise date-time stamps, unit measures, and value per unit. An efficient solution for controlling document types and IDs."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616401784845-180882ba9ba8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnZlbnRvcnl8ZW58MHx8fHwxNjk1NDY5NTA0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Velocity Inventory: Streamlining your inventory records with precise date-time stamps, unit measures, and value per unit. An efficient solution for controlling document types and IDs.`}
            </Text>
            <Box
